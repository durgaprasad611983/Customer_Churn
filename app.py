...
@st.cache_resource
def load_artifact():
    with open("https://github.com/durgaprasad611983/Customer_Churn/churn_model.pkl", "rb") as f:
        return pickle.load(f)

@st.cache_data
def load_data():
    return pd.read_csv("https://github.com/durgaprasad611983/Customer_Churn/customer_churn_dataset.csv")
